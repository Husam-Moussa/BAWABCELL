...
const products = [
  ...
  },
  {
    ...
    type: "Tablets",
    images: [
      "HomeImages/AppleProducts/ipad_pro_13_m4_2.png",
      "HomeImages/AppleProducts/ipad_pro_13_m4_3.png",
      "HomeImages/AppleProducts/ipad_pro_13_m4_4.png",
  ...
  },
  {
    ...
    type: "Accessories",
    images: [
      "HomeImages/AppleProducts/meen_airtag_1.png",
      "HomeImages/AppleProducts/meen_airtag_2.png",
    ],
  },
  {
    name: "Apple tv",
...
export default function ProductSlider3() {
  ...
  return (
    <section className="w-full mt-10 px-4 py-10">
      <h2 className="text-4xl mb-6 text-gray-600" data-aos="fade-right">Apple Products</h2>
